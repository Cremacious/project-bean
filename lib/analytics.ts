...
// Key segments that mark a param as personal and must never reach analytics.
...
/** Split a param key into lowercased segments for the personal-key check. */
...
/** True when a key looks like it could carry personal data. */
